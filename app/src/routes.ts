...
export let routes = [
  ...
  { settings: { category: gettingStarted, icon: 'settings' }, route: 'aurelia', moduleId: PLATFORM.moduleName('routes/aurelia.html'), name: 'aurelia', title: 'Aurelia', nav: true },
  { settings: { category: gettingStarted, icon: 'settings' }, route: 'install', moduleId: PLATFORM.moduleName('routes/install.html'), name: 'install', title: 'Install', nav: true },
