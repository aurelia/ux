define('@aurelia-ux/grid', ['exports', 'aurelia-templating', 'aurelia-dependency-injection', '@aurelia-ux/core', 'aurelia-pal'], function (exports, aureliaTemplating, aureliaDependencyInjection, core, aureliaPal) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var UxGridCell = /** @class */ (function () {
        ...
        UxGridCell = __decorate([
            ...
            aureliaTemplating.customElement('ux-grid-cell'),
    ...
    var UxResponsiveUtilities = /** @class */ (function () {
        function UxResponsiveUtilities() {
            ...
            aureliaPal.PLATFORM.global.addEventListener('resize', function () { return _this.onResize(); });
        ...
        UxResponsiveUtilities.prototype.dispose = function () {
            aureliaPal.PLATFORM.global.removeEventListener('resize', this.calculateResponsiveValues);
        };
