...
export default ([
  {
    ...
    plugins: [
      ...
      copy({
        verbose: true,
        files: [
          { from: 'src/ux-select.css', to: 'dist/es2015/ux-select.css' }
        ]
      }),
      html({
        include: '**/*.html',
  ...
  : [{
    ...
    output: [
      ...
      { file: 'dist/amd/index.js', format: 'amd', amd: { id: '@aurelia-ux/select' } },
    ...
    plugins: [
      ...
      copy({
        verbose: true,
        files: [
          { from: 'src/ux-select.css', to: 'dist/commonjs/ux-select.css' },
          { from: 'src/ux-select.css', to: 'dist/amd/ux-select.css' },
          { from: 'src/ux-select.css', to: 'dist/native-modules/ux-select.css' },
        ]
      }),
      html({
        include: '**/*.html',
