...
let UxSelect = /** @class */ (() => {
    let UxSelect = class UxSelect {
        constructor(element, styleEngine, observerLocator, taskQueue, defaultConfiguration, positioningFactory) {
        ...
        collapse() {
            ...
            setTimeout(() => {
                var _a;
                (_a = this.optionWrapperEl) === null || _a === void 0 ? void 0 : _a.classList.remove('ux-select__list-wrapper--open');
...
const defineUxSelectElementApis = (element) => {
