...
export default ([
  {
    ...
    plugins: [
      ...
      copy({
        verbose: true,
        files: [
          { from: 'src/ux-switch.css', to: 'dist/es2015/ux-switch.css' }
        ]
      }),
      html({
        include: '**/*.html',
  ...
  : [{
    ...
    output: [
      ...
      { file: 'dist/amd/index.js', format: 'amd', amd: { id: '@aurelia-ux/switch' } },
    ...
    plugins: [
      ...
      copy({
        verbose: true,
        files: [
          { from: 'src/ux-switch.css', to: 'dist/amd/ux-switch.css' },
          { from: 'src/ux-switch.css', to: 'dist/commonjs/ux-switch.css' },
          { from: 'src/ux-switch.css', to: 'dist/native-modules/ux-switch.css' }
        ]
      }),
      html({
        include: '**/*.html',
